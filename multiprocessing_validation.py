...
# 6 queues for storing output from each process function.
...
#To apply Exponentiial Smothing I took idea from this notebook: https://www.kaggle.com/marisakamozz/m5-exponential-smoothing
...
def prediction1(i):
    ...
    row = [i,sub.iloc[i,0]]+list(df['forecast'].values)
